...
具体实现在 keychron/v3_max分支

经过近2周的设计/调试/踩坑,我完成了空明码并击方案在qmk上的配置,并测试通过.
实现我的硬件并击梦想.

它的最大挑战是: 小写方案已经达到了 1159组并击键.
所以我使用了脚本来辅助管理生成:
...
* 该键盘使用存储芯片有256KB存储空间
固件不添加任何代码编译后，原生大小为：94KB
增加1159组(2击4击混合)并击实现之后+之前原有的固件,增加了45KB至139KB.
预计能容纳的并击量为4100+组COMBO宏.
